...
- [統計分析法　第一回レポート](#統計分析法第一回レポート)
  - [実行環境](#実行環境)
  - [準備:データを取得する](#準備データを取得する)
  - [1 量的データの基本統計量](#1-量的データの基本統計量)
    - [task 1-1:母集団の分布を確認する](#task-1-1母集団の分布を確認する)
        - [実行結果](#実行結果)
    - [task 1-2:母集団の基本統計量を調べる](#task-1-2母集団の基本統計量を調べる)
        - [実行結果](#実行結果-1)
    - [task 1-3:母平均の推定](#task-1-3母平均の推定)
      - [点推定](#点推定)
      - [区間推定](#区間推定)
        - [実行結果](#実行結果-2)
  - [2 仮説検定](#2-仮説検定)
    - [今回使うデータについて](#今回使うデータについて)
    - [task 2-1:質的データの検定](#task-2-1質的データの検定)
      - [科目平均の差に意味があるかの検定](#科目平均の差に意味があるかの検定)
      - [異なる学生グループの科目平均の差に意味があるかの検定](#異なる学生グループの科目平均の差に意味があるかの検定)
        - [実行結果](#実行結果-3)
    - [task2-2 : 名義データについて、関係があるかを検定する](#task2-2--名義データについて関係があるかを検定する)
        - [実行結果](#実行結果-4)
